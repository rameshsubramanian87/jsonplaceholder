# jsonplaceholder OpenAPI Specification
[![Build Status](https://travis-ci.org/rameshsubramanian87/jsonplaceholder.svg?branch=master)](https://travis-ci.org/rameshsubramanian87/jsonplaceholder)
...
6. If you did everything correct, https://rameshsubramanian87.github.io/jsonplaceholder/ will lead to your new docs
...
- Documentation(ReDoc): https://rameshsubramanian87.github.io/jsonplaceholder/
- Look full spec:
    + JSON https://rameshsubramanian87.github.io/jsonplaceholder/swagger.json
    + YAML https://rameshsubramanian87.github.io/jsonplaceholder/swagger.yaml
- Preview spec version for branch `[branch]`: https://rameshsubramanian87.github.io/jsonplaceholder/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://rameshsubramanian87.github.io/jsonplaceholder/ with url from the message: `Server started <url>`
